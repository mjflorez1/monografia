...
sol_0 = np.loadtxt("txt/gauss_cauchy/outs_gauss_cauchy0.txt")
sol_1 = np.loadtxt("txt/gauss_cauchy/outs_gauss_cauchy1.txt")
sol_2 = np.loadtxt("txt/gauss_cauchy/outs_gauss_cauchy2.txt")
sol_3 = np.loadtxt("txt/gauss_cauchy/outs_gauss_cauchy3.txt")
