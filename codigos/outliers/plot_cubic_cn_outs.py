...
sol_0 = np.loadtxt("txt/cubic_cn/out_cun_0.txt")
sol_1 = np.loadtxt("txt/cubic_cn/out_cun_1.txt")
sol_2 = np.loadtxt("txt/cubic_cn/out_cun_2.txt")
sol_3 = np.loadtxt("txt/cubic_cn/out_cun_3.txt")
sol_4 = np.loadtxt("txt/cubic_cn/out_cun_4.txt")
sol_5 = np.loadtxt("txt/cubic_cn/out_cun_5.txt")
sol_6 = np.loadtxt("txt/cubic_cn/out_cun_6.txt")
sol_7 = np.loadtxt("txt/cubic_cn/out_cun_7.txt")
sol_8 = np.loadtxt("txt/cubic_cn/out_cun_8.txt")
sol_9 = np.loadtxt("txt/cubic_cn/out_cun_9.txt")
sol_10 = np.loadtxt("txt/cubic_cn/out_cun_10.txt")
...
plt.savefig("figuras/cubic_cn_outliers.pdf",bbox_inches="tight")
plt.show()
