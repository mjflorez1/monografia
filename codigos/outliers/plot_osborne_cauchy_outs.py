...
sol_0 = np.loadtxt("txt/osborne_cauchy/outs_osborne_cauchy0.txt")
sol_1 = np.loadtxt("txt/osborne_cauchy/outs_osborne_cauchy1.txt")
sol_2 = np.loadtxt("txt/osborne_cauchy/outs_osborne_cauchy2.txt")
sol_3 = np.loadtxt("txt/osborne_cauchy/outs_osborne_cauchy3.txt")
sol_4 = np.loadtxt("txt/osborne_cauchy/outs_osborne_cauchy4.txt")
sol_5 = np.loadtxt("txt/osborne_cauchy/outs_osborne_cauchy5.txt")
...
plt.savefig("figuras/osborne_cauchy_outliers.pdf",bbox_inches="tight")
plt.show()
