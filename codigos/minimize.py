...
# ---------------------- GRÁFICA FINAL ----------------------
plt.figure()
plt.scatter(t, y, color='black', label='Datos observados')
plt.plot(t, y_fit, 'b-', linewidth=1.5, label='Ajuste con OLS')
plt.plot(t, y_ovo, 'm-', linewidth=1.5, label='Ajuste OVO')
plt.legend(loc='lower right')
plt.savefig("figuras/comparacion_ovo_ols.pdf", bbox_inches='tight')
plt.show()