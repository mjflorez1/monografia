...
% Depuración: Mostrar coeficientes de polyfit
disp('Coeficientes obtenidos con polyfit:');
disp(coef_polyfit);

% Evaluar el polinomio ajustado con polyfit
y_fit_polyfit = polyval(coef_polyfit, t);
disp('Valores ajustados con polyfit:');
disp(y_fit_polyfit);
...
plot(t, y_fit_polyfit, 'g-', 'LineWidth', 2, 'DisplayName', 'Ajuste polyfit'); % Se cambió '--' por '-'
